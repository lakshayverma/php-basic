                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input  id="user_name"
                                ...
                                type="text"
                                required
                                value="<?php echo $object->user_name; ?>"
                        />
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input  id="first_name"
                                ...
                                type="text"
                                required
                                value="<?php echo $object->first_name; ?>"
                        />
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input  id="last_name"
                                ...
                                type="text"
                                required
                                value="<?php echo $object->last_name; ?>"
                        />
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <textarea   id="address"
                                    ...
                                    class="form-control"
                                    required
                        ><?php echo $object->address; ?></textarea>
                    </div>
                </div>
