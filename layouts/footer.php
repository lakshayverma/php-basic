...
?>
    ...
    <footer class="container-fluid" id="page_footer">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="row">
                <a href="https://twitter.com/lakshay__verma"
                    class="twitter-follow-button"
                    data-show-count="false"
                    data-size="large">
                    Follow @lakshay__verma
                </a>
            ...
            <div class="row">
                ...
                <div class="fb-like" data-href="https://facebook.com/lk.lakshay"
            ...
            <div class="row">
                ...
                <div class="g-plusone"
                    ...
                    data-href="https://plus.google.com/u/0/+LakshayVermaS">
                </div>
            </div>
            <div class="row">
                <a class="wordpress-follow-button btn btn-default"
                    href="https://vermalakshay.wordpress.com"
                    data-blog="https://vermalakshay.wordpress.com"
                    data-lang="en"
                    data-show-follower-count="true">
                    Follow Lakshay Talks on WordPress.com
                </a>
